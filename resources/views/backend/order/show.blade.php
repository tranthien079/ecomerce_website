            ...
            <div class="order-info">
              ...
              <table class="table">
                    ...
                    <tr>
                        ...
                        <td> : @if($order->payment_method=='cod') Thanh toán khi nhận hàng @else Chuyển khoản @endif</td>
                    </tr>
                    <tr>
                        <td>Trạng thái thanh toán</td>
                        <td> : @if($order->payment_status == 'unpaid') 
                         <span class="badge-danger text-center p-2">Chưa thanh toán</span> 
                           @else
                           <span class="badge-success text-center p-2">Đã thanh toán</span> 
                            @endif
                          </td>
                    </tr>
              </table>
